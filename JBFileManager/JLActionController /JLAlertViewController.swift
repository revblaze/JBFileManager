...
class JLAlertViewController: UIViewController {
    ...
    fileprivate var inputPlaceholderText:String?
    ...
    override func viewDidLoad() {
        ...
        if inputStyle == .none {
            ...
            inputTextField.addTarget(self, action: #selector(JLAlertViewController.textFieldStringDidChange(_:)), for: .editingChanged)
            ...
            inputTextField.isSecureTextEntry = (inputStyle == .secureText)
        ...
        if let regularText = regularButtonText {
            ...
            if inputStyle.isInputType() {
                ...
                regularButton.setTitleColor(enabledButtonColor, for: UIControlState())
            }
        }
        else {
            ...
            if let inputTextField = inputField {
                ...
                DispatchQueue.main.asyncAfter(deadline: delayTime) {
                    ...
                    if inputTextField.text?.characters.count > 0 {
                        self.regularButton.setTitleColor(self.enabledButtonColor, for: UIControlState())
                    }
                }
            }
        }
    ...
    func textFieldStringDidChange(_ sender:AnyObject)
    {
